...
import com.curso.teste.entities.Payment;
...
import com.curso.teste.repositories.CategoryRepository;
import com.curso.teste.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Payment p01 = new Payment(null, Instant.parse("2019-06-20T21:53:07Z"), o1);
		o1.setPayment(p01);
